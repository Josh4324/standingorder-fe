...
import { CCard, CCol, CCardBody, CCardHeader, CRow } from "@coreui/react";
import bankdata from "../../bank";
import "react-confirm-alert/src/react-confirm-alert.css";

const AdminPendingStandingOrder = () => {
  ...
  const getData = () => {
    fetch(`${api_base_url}/api/standorder/pending/admin`, {
      method: "GET", // or 'PUT'
      headers: {
...
export default AdminPendingStandingOrder;
