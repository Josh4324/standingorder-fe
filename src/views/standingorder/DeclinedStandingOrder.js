...
const DeclinedStandingOrder = () => {
      ...
      .then((data) => {
        if (data.status === "Success") {
          ...
          NotificationManager.error(
            "Error trying to deactivate Stand order",
            "Error"
          );
        }
      })
  ...
  const getData = () => {
    fetch(`${api_base_url}/api/standorder/declined/inputter`, {
      method: "GET", // or 'PUT'
      headers: {
        "Content-Type": "application/json",
        authorization: token,
...
export default DeclinedStandingOrder;
