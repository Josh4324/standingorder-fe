  ...
  return (
    <>
        ...
        <CCardBody>
          <CFormGroup>
            ...
            <CSelect
              innerRef={bankRef}
              required
              onChange={(evt) => props.handleChange(evt, props.id)}
              data-key={props.id}
              name="bank"
              id="select"
            >
      ...
      <CCard className="my-3">
        <CCardBody>
          <CFormGroup>
            <CLabel htmlFor="standing">
              Do you want to move all the money from your account to this
              beneficiary account?
            </CLabel>
            <div>
              <input
          ...
          <CFormGroup>
            ...
            <CInput
              ...
              name="amount"
              data-key={props.id}
              placeholder="Enter standing order amount"
            />
          </CFormGroup>
          <CFormGroup>
            <CLabel htmlFor="select">FREQUENCY OF PAYMENT</CLabel>
            <CSelect
              innerRef={props.frequencyRef}
              required
              onChange={(evt) => props.handleChange(evt, props.id)}
              data-key={props.id}
              name="frequency"
